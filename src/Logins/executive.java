...
public void details4(){
         try{
            ...
            String query="SELECT * FROM stand_desc where st_id=4";        
    ...
    private void initComponents() {
        ...
        jLabel2.setText("STAND NAME-EXECUTIVE");

        exe.setColumns(20);
        exe.setRows(5);
        jScrollPane1.setViewportView(exe);
    ...
    private javax.swing.JTextArea exe;
