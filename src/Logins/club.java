...
public class club extends javax.swing.JFrame {
    ...
    public void details2(){
         try{
            ...
            String query="SELECT * FROM stand_desc where st_id=2";        
    ...
    private void initComponents() {
        ...
        clubtext = new javax.swing.JTextArea();
        ...
        jLabel2.setText("STAND NAME-CLUB");

        clubtext.setColumns(20);
        clubtext.setRows(5);
        jScrollPane1.setViewportView(clubtext);
    ...
    private void systemExit()
   {
    ...
    private javax.swing.JTextArea clubtext;
